function [ trial_data, trial_time ] = run_trial_OT_ephys( trial_idx, task, run_obj, scanimage_client, trial_core_name )
...
% Ephys channels
ai_channels_used_1 = [4:9];
aI1 = s.addAnalogInputChannel('Dev3', ai_channels_used_1, 'Voltage');
for i=1:length(ai_channels_used_1)
    aI1(i).InputType = 'SingleEnded';
end
